...
- (void)kfSetupResizeCursors
{
    NSImage *isVerticalImage = [NSImage imageNamed:@"NSTruthHorizontalResizeCursor"]; // standard Jaguar NSSplitView resize cursor
	if (!isVerticalImage)
	...
	NSImage *isNotVerticalImage = [NSImage imageNamed:@"NSTruthVerticalResizeCursor"]; // standard Jaguar NSSplitView resize cursor
